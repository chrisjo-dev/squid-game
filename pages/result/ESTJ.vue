...
export default {
  ...
  data() {
    return {
      ...
      mbtiInfo2_text: [
        ...
        "Carry out a task under certain rules.",
  ...
  head() {
    return {
      title: "You are VIPS in Squid game",
      meta: [
        {
          hid: "title",
          name: "og:title",
          content: "You are VIPS in Squid game",
        },
        {
          hid: "description",
          name: "og:description",
        ...
        },
        {
          hid: "image",
          name: "og:image",
          content: `${process.env.baseURL}/image/meta_eng/metaimg_ESTJ.png`,
        },
        // Twitter Open Graph
        {
          hid: "twitter:title",
